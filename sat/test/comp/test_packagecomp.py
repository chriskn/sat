...
class TestPackageComp(unittest.TestCase):
    ...
    @mock.patch("comp.packagerepo.packages")
    ...
    def test_analyse_creates_expected_dataframe(self, mock_package_repo):
        ...
        self.assertEqual(packages, [_PACKAGE_5, _PACKAGE_3_DUPLICATED, _PACKAGE_1,
                                    _PACKAGE_2, _PACKAGE_4, _PACKAGE_3_DUPLICATED, _PACKAGE_3_DUPLICATED])
        self.assertEqual(paths, [_FULL_PATH_PACKAGE_5, _FULL_PATH_PACKAGE_3, _FULL_PATH_PACKAGE_1,
                                 _FULL_PATH_PACKAGE_2, _FULL_PATH_PACKAGE_4, _FULL_PATH_PACKAGE_6, _FULL_PATH_PACKAGE_6])
    ...
    def test_write_results_calls_plot_treemap_for_av_type_comp(self, mock_package_repo, write_xls, plot_treemap):
        ...
        self.sut.analyse("")
        self.sut.write_results(odir)
        expected_avt_call = mock.call(ANY, "av class complexity per package",
    ...
    def test_write_results_calls_plot_treemap_for_av_method_comp(self, mock_package_repo, write_xls, plot_treemap):
        ...
        self.sut.analyse("")
        self.sut.write_results(odir)
        expected_avm_call = mock.call(ANY, "av method complexity per package",
    ...
    def test_write_results_plots_expected_data_for_total_comp(self, mock_package_repo, write_xls, plot_treemap):
        ...
        self.assertEqual(packages, [_PACKAGE_5, _PACKAGE_3_DUPLICATED, _PACKAGE_1, _PACKAGE_2])
